...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30_angular2_multiselect_dropdown__ = __webpack_require__(1500);
            ...
            if (this.mode == "edit") {
                if (!!this.activatedRoute.snapshot.params['id']) {
                    ...
                    if (loadedValue != null) {
                        ...
                        this.form.patchValue({ ROOMNO: loadedValue.ROOMNO, DESCRIPTION: loadedValue.DESCRIPTION, branch: branch });
                    }
                }
            }
        }, (err) => { });

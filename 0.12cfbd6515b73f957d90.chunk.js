...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__masters_routing__ = __webpack_require__(1545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__masters_component__ = __webpack_require__(1518);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__common_services_permission_guard_service__ = __webpack_require__(638);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Employee_EmployeeList_component__ = __webpack_require__(1503);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_Customer_CustomerList_component__ = __webpack_require__(1499);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_Customer_AddCustomer_component__ = __webpack_require__(1498);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_Rooms_RoomList_component__ = __webpack_require__(1511);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_Rooms_AddRoom_component__ = __webpack_require__(1510);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_Services_ServiceList_component__ = __webpack_require__(1517);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_Services_AddService_component__ = __webpack_require__(1516);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_Employee_AddEmployee_component__ = __webpack_require__(1502);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_Series_SeriesList_component__ = __webpack_require__(1515);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_Series_AddSeries_component__ = __webpack_require__(1514);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_SeriesSales_AddSeriesSales_component__ = __webpack_require__(1512);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_SeriesSales_SeriesSalesList_component__ = __webpack_require__(1513);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__components_Medication_MedicationList_component__ = __webpack_require__(1507);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__components_Disease_DiseaseList_component__ = __webpack_require__(1501);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__components_Disease_AddDisease_component__ = __webpack_require__(1500);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__components_Medication_AddMedication_component__ = __webpack_require__(1506);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__components_HolidayEntry_holidayEntry_component__ = __webpack_require__(1505);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__components_HolidayEntry_addHoliday_component__ = __webpack_require__(1504);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__common_nepali_date_picker_nepali_date_picker_module__ = __webpack_require__(1491);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__components_Prescription_PrescriptionList_component__ = __webpack_require__(1509);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__components_Prescription_AddPrescription_component__ = __webpack_require__(1508);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_global_state__ = __webpack_require__(58);
...
let AddEmployee = class AddEmployee {
    ...
    ngOnInit() {
        ...
        if (this.mode == 'edit') {
            if (!!this.activatedRoute.snapshot.params['id']) {
                let id = this.activatedRoute.snapshot.params['id'];
                let loadedValue = this.masterRepo._employeeList.filter(r => r.EMPLOYEEID == id)[0];
                if (loadedValue != null) {
                    this.form.setValue({
                        EMPLOYEEID: loadedValue.EMPLOYEEID,
                        NAME: loadedValue.NAME,
                        ADDRESS: loadedValue.ADDRESS,
                        TELNO: loadedValue.TELNO,
                        MOBILE: loadedValue.MOBILE,
                        DESIGNATION: loadedValue.DESIGNATION,
                        OFFDAY: loadedValue.OFFDAY,
                        EMERGENCYCONTACTNAME: loadedValue.EMERGENCYCONTACTNAME,
                        EMERGENCYCONTACTNO: loadedValue.EMERGENCYCONTACTNO,
                        Inactive: loadedValue.Inactive
                    });
                    for (let d of this.Days) {
                        d.checked = loadedValue.OFFDAY.indexOf(d.day) > -1;
                    }
                }
            }
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ng2_bootstrap__ = __webpack_require__(1378);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_repositories__ = __webpack_require__(158);
...
let AddHolidayComponent = class AddHolidayComponent {
    ...
    changeFromDate(value, format) {
        ...
        if (format == "AD") {
            var adDate = (value.replace("-", "/")).replace("-", "/");
            var bsDate = adbs.ad2bs(adDate);
            this.fromDateBS = bsDate.en.year + '-' + bsDate.en.month + '-' + (bsDate.en.day == '1' || bsDate.en.day == '2' || bsDate.en.day == '3' || bsDate.en.day == '4' || bsDate.en.day == '5' || bsDate.en.day == '6' || bsDate.en.day == '7' || bsDate.en.day == '8' || bsDate.en.day == '9' ? '0' + bsDate.en.day : bsDate.en.day);
        }
        else if (format == "BS") {
            var bsDate = (value.replace("-", "/")).replace("-", "/");
            var adDate = adbs.bs2ad(bsDate);
            this.fromDate = (adDate.year + '-' + ((adDate.month).toString().length == 1 ? '0' + adDate.month : adDate.month) + '-' + ((adDate.day).toString().length == 1 ? '0' + adDate.day : adDate.day));
        }
    }
    changeToDate(value, format) {
        var adbs = __webpack_require__(1464);
        if (format == "AD") {
            ...
            var bsDate = (value.replace("-", "/")).replace("-", "/");
            var adDate = adbs.bs2ad(bsDate);
            this.toDate = (adDate.year + '-' + ((adDate.month).toString().length == 1 ? '0' + adDate.month : adDate.month) + '-' + ((adDate.day).toString().length == 1 ? '0' + adDate.day : adDate.day));
        }
    }
    onSubmit() {
        try {
    ...
    ngOnInit() {
        ...
        if (this.mode == "edit") {
            if (!!this.activatedRoute.snapshot.params['id']) {
                ...
                if (loadedValue != null) {
                    this.form.setValue({ ROOMNO: loadedValue.ROOMNO, DESCRIPTION: loadedValue.DESCRIPTION });
                }
            }
        }
        // if (!!this.activatedRoute.snapshot.params['mode']) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__masters_component__ = __webpack_require__(1518);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_services_permission_guard_service__ = __webpack_require__(638);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Employee_EmployeeList_component__ = __webpack_require__(1503);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Employee_AddEmployee_component__ = __webpack_require__(1502);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_Customer_CustomerList_component__ = __webpack_require__(1499);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_Customer_AddCustomer_component__ = __webpack_require__(1498);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_Rooms_RoomList_component__ = __webpack_require__(1511);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_Rooms_AddRoom_component__ = __webpack_require__(1510);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_Services_ServiceList_component__ = __webpack_require__(1517);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__components_Services_AddService_component__ = __webpack_require__(1516);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_Series_SeriesList_component__ = __webpack_require__(1515);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_Series_AddSeries_component__ = __webpack_require__(1514);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_SeriesSales_AddSeriesSales_component__ = __webpack_require__(1512);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_SeriesSales_SeriesSalesList_component__ = __webpack_require__(1513);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_Disease_AddDisease_component__ = __webpack_require__(1500);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_Disease_DiseaseList_component__ = __webpack_require__(1501);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_Medication_AddMedication_component__ = __webpack_require__(1506);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_Medication_MedicationList_component__ = __webpack_require__(1507);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_HolidayEntry_holidayEntry_component__ = __webpack_require__(1505);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_HolidayEntry_addHoliday_component__ = __webpack_require__(1504);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__components_Prescription_PrescriptionList_component__ = __webpack_require__(1509);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__components_Prescription_AddPrescription_component__ = __webpack_require__(1508);

...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__userManager_component__ = __webpack_require__(1551);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_services_permission_guard_service__ = __webpack_require__(637);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_userManger_adduser_component__ = __webpack_require__(1547);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_userManger_userList_component__ = __webpack_require__(1550);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_ng2_bootstrap__ = __webpack_require__(1377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__userManager_routing__ = __webpack_require__(1561);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_userManger_roles_roleList_component__ = __webpack_require__(1549);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_userManger_roles_addRole_component__ = __webpack_require__(1548);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_style_loader_grid_scss__ = __webpack_require__(1615);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__adduser_service__ = __webpack_require__(1492);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ng2_bootstrap__ = __webpack_require__(1377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__common_repositories__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__adduser_service__ = __webpack_require__(1492);
...
let AddRole = class AddRole {
    constructor(addUserService, router, activatedRoute, service) {
        this.addUserService = addUserService;
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.service = service;
    ...
    ngOnInit() {
        this.service.recursiveForEach(__WEBPACK_IMPORTED_MODULE_4__pages_menu__["a" /* PAGES_MENU */], (item) => {
            ...
            this.menuRights.push({
                ...
                allowCreate: this.service.coalesce(menu && menu.allowCreate, true),
                allowEdit: this.service.coalesce(menu && menu.allowEdit, true),
                allowDelete: this.service.coalesce(menu && menu.allowDelete, true),
                create: this.service.coalesce(menu && menu.allowCreate, true),
                edit: this.service.coalesce(menu && menu.allowEdit, true),
                delete: this.service.coalesce(menu && menu.allowDelete, true),
            });
        });
        if (this.mode === "edit") {
            this.loadUserRights();
    ...
    loadUserRights() {
        this.addUserService.getUserRole(this.role).subscribe((response) => {
            response.json().menuRights.forEach((userRight) => {
                var mRight = this.menuRights.find((menuRight) => menuRight.menuId === userRight.menuId);
...
AddRole = __decorate([
    ...
    __metadata('design:paramtypes', [__WEBPACK_IMPORTED_MODULE_1__adduser_service__["a" /* AddUserService */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */], __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* ActivatedRoute */], __WEBPACK_IMPORTED_MODULE_3__common_repositories__["a" /* MasterRepo */]])
], AddRole);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_style_loader_smartTables_scss__ = __webpack_require__(1554);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__adduser_service__ = __webpack_require__(1492);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__common_repositories_masterRepo_service__ = __webpack_require__(636);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_userManger_adduser_component__ = __webpack_require__(1547);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__userManager_component__ = __webpack_require__(1551);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_userManger_userList_component__ = __webpack_require__(1550);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_userManger_roles_roleList_component__ = __webpack_require__(1549);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_userManger_roles_addRole_component__ = __webpack_require__(1548);

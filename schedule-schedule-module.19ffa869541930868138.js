...
var CustomerSelect = /** @class */ (function () {
    ...
    CustomerSelect.prototype.getCustomerList = function (name, mobile) {
        ...
        // Prevent new API call if already loading
        if (this.isLoading)
            return;
        var pageNumber = 1;
        var rowCount = 10;

...
var AddDisease = /** @class */ (function () {
    ...
    AddDisease.prototype.addPrescription = function (e, Prescriptions) {
        if (e.target.value !== "") {
...
var DiseaseList = /** @class */ (function () {
    function DiseaseList(service, _authService, router) {
        ...
        this.service.getDiseaseList().subscribe(function (data) {
            ...
            _this.service._diseaseList = Dlist;
            _this.source.load(Dlist);
        });
    }
        ...
        this.masterRepo.getBranchList().subscribe(function (response) {
            ...
            if (_this.mode == "edit") {
                if (!!_this.activatedRoute.snapshot.params['id']) {
                    ...
                    var loadedValue_1 = _this.masterRepo._roomList.filter(function (r) { return r.ROOMNO == id_1; })[0];
                    if (loadedValue_1 != null) {
                        var branch = {};
...
var AddService = /** @class */ (function () {
    ...
    AddService.prototype.ngOnInit = function () {
        ...
        this.form.get('MappingCode').valueChanges.subscribe(function (selectedValue) {
            var selectedOption = _this.ItemList.find(function (option) { return option.Id === selectedValue; });
            if (selectedOption) {
                _this.form.get('DESCRIPTION').setValue(selectedOption.ItemName, { emitEvent: false });
            }
        });
        if (this.mode == "edit") {
            if (!!this.activatedRoute.snapshot.params['id']) {
...
var MastersModule = /** @class */ (function () {
    ...
    MastersModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_components_Employee_EmployeeList_component__WEBPACK_IMPORTED_MODULE_10__["EmployeeList"],
